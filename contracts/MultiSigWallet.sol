...
contract MultiSigWallet {
    ...
    constructor(address[] memory _owners, uint256 _required) payable validRequirement(_owners.length, _required) {
    ...
    /// @return transactionId is returned.
    ...
    /// @param transactionId Transaction ID.
    /// @return count is the number of confirmations.
    ...
    /// @return count is the total number of transactions after filters are applied.
    ...
    /// @param transactionId Transaction ID.
    /// @return _confirmations is an array of owner addresses.
    ...
    /// @param pending Include pending transactions.
    /// @param executed Include executed transactions.
    /// @return _transactionIds is an array of transaction IDs.
