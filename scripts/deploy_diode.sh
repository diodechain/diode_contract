...
set -x
export RPC=https://us2.prenet.diode.io:8443
export RPC=http://localhost:3834
forge -vvvvv create --legacy --evm-version constantinople --optimize --optimizer-runs 200 --rpc-url $RPC --private-key $(cat diode_glmr.key) $*
