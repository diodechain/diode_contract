...
# New Deployment for individual deployments of proxy contracts
# ./scripts/deploy_oasis.sh contracts/ZTNAOrganisation.sol:ZTNAOrganisation --constructor-args 0xf90314E31D34C7ad82382f1a9dCB5Fc0FDA71ACe
# ./scripts/deploy_oasis.sh contracts/ZTNAPerimeterContract.sol:ZTNAPerimeterContract
# ./scripts/deploy_oasis.sh contracts/ZTNAWallet.sol:ZTNAWallet
...
export ETH_GAS_LIMIT=10000000
set -x
# forge compile --evm-version paris --optimize --optimizer-runs 200 --sizes contracts/ZTNAPerimeterRegistry.sol
